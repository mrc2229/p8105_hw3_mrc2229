...
In `r state_locations %>% filter (year==2002) %>% summarise(n_distinct(locationabbr))` states had 7 or more locations.

In `r state_locations %>% filter (year==2010) %>% summarise(n_distinct(locationabbr))` states had 7 or more locations.